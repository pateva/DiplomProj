package com.example.diplproj.utils;

public class Constants {
    public static final String ENUM_VALUE_NOT_ALLOWED_ERROR_MSG = "A %s with this id does not exist";
    public static final String ENTITY_DOES_NOT_EXISTS_ERROR_MSG = "%s with %s does not exist";
